...
public class Entry {
	...
	public static void main(String[] args) {
		...
		if (Configuration.getMode() == ModeType.LIST) {
			...
			Formatter.waitForTaskCompletion(client.addVM(Configuration.getOrganization(), Configuration.getVDC(), Configuration.getVApp(), Configuration.getCatalog(), Configuration.getTemplate(), Configuration.getFqdn(), Configuration.getDescription(), Configuration.getIp().getHostAddress(), Configuration.getNetwork(), Configuration.hasIpAddressAllocationMode()? Configuration.getIpAddressAllocationMode() : "MANUAL"));
